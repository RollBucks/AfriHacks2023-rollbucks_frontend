...
export const Footer = () => {
    return (
        <footer className="p-[32px] h-screen">
            ...
            >
                <h1 className="text-6xl font-bold text-center">Seamless Pay for <br /> African Talent</h1>
                <Link to="register" className="font-bold font-body text-black-400 rounded-xl py-4 px-3 text-sm bg-yellow hover:bg-white-400 hover:text-black-400">Join RollBucks. Now</Link>
            </section>
            <section className='flex items-center justify-between h-1/5'>
